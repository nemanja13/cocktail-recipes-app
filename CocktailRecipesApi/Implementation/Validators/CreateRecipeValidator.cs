...
namespace Implementation.Validators
{
    ...
    {
        public CreateRecipeValidator(CocktailRecipesContext context)
        {
            RuleFor(r => r.Name).NotEmpty()
                ...
                {
                    RuleFor(r => r.Name)
                    .Must(name => !context.CocktailRecipes.Any(c => c.Name == name))
            ...
            RuleFor(r => r.Image).NotEmpty()
                .WithMessage("Cocktail {PropertyName} must not be empty.");
